...
if run_name == "run5.1":
    activation_str = "relu"
elif run_name == "run5.2":
    activation_str = "tanh"
elif run_name == "run5.3":
    activation_str = "elu"

model = Sequential()
model.add(Conv2D(100, (1, 10), strides=(1, 2), padding='valid', activation=activation_str, input_shape=(5, 512, 1)))
model.add(Conv2D(100, (1, 10), strides=(1, 2), padding='valid', activation=activation_str))
model.add(Conv2D(100, (1, 10), strides=(1, 2), padding='valid', activation=activation_str))
model.add(Conv2D(100, (1, 10), strides=(1, 2), padding='valid', activation=activation_str))
model.add(Conv2D(100, (1, 10), strides=(1, 2), padding='valid', activation=activation_str))
...
model.add(Activation(activation_str))
model.add(Dense(5 * 512))

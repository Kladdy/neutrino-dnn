...
if run_name == "run35.1":
    ...
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
elif run_name == "run35.2":
    model.add(Conv2D(conv2D_filter_amount, (4, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu', input_shape=(5, 512, 1)))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
elif run_name == "run35.3":
    ...
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
elif run_name == "run35.4":
    model.add(Conv2D(conv2D_filter_amount, (4, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu', input_shape=(5, 512, 1)))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
elif run_name == "run35.5":
    model.add(Conv2D(conv2D_filter_amount, (4, conv2D_filter_size), strides=(1, stride_length), padding='same', activation='relu', input_shape=(5, 512, 1)))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
elif run_name == "run35.6":
    model.add(Conv2D(conv2D_filter_amount, (4, conv2D_filter_size), strides=(1, stride_length), padding='same', activation='relu', input_shape=(5, 512, 1)))
    model.add(Conv2D(conv2D_filter_amount, (4, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
elif run_name == "run35.7":
    model.add(Conv2D(conv2D_filter_amount, (4, conv2D_filter_size), strides=(1, stride_length), padding='same', activation='relu', input_shape=(5, 512, 1)))
    model.add(Conv2D(conv2D_filter_amount, (4, conv2D_filter_size), strides=(1, stride_length), padding='same', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
elif run_name == "run35.8":
    model.add(Conv2D(conv2D_filter_amount, (4, conv2D_filter_size), strides=(1, stride_length), padding='same', activation='relu', input_shape=(5, 512, 1)))
    model.add(Conv2D(conv2D_filter_amount, (4, conv2D_filter_size), strides=(1, stride_length), padding='same', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (4, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
elif run_name == "run35.9":
    model.add(Conv2D(conv2D_filter_amount, (4, conv2D_filter_size), strides=(1, stride_length), padding='same', activation='relu', input_shape=(5, 512, 1)))
    model.add(Conv2D(conv2D_filter_amount, (4, conv2D_filter_size), strides=(1, stride_length), padding='same', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (4, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))

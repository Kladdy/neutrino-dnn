...
if this_run_id == "1":
    ...
    model.add(Conv2D(conv2D_filter_amount, (4, conv2D_filter_size), strides=(1, stride_length), padding='same', activation='relu', input_shape=(5, 512, 1)))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    ...
    model.add(Conv2D(conv2D_filter_amount, (4, conv2D_filter_size), strides=(1, stride_length), padding='same', activation='relu', input_shape=(5, 512, 1)))
    model.add(Conv2D(conv2D_filter_amount, (4, conv2D_filter_size), strides=(1, stride_length), padding='same', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    ...
    model.add(Conv2D(conv2D_filter_amount, (5, conv2D_filter_size), strides=(1, stride_length), padding='same', activation='relu', input_shape=(5, 512, 1)))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    ...
    model.add(Conv2D(conv2D_filter_amount, (5, conv2D_filter_size), strides=(1, stride_length), padding='same', activation='relu', input_shape=(5, 512, 1)))
    model.add(Conv2D(conv2D_filter_amount, (5, conv2D_filter_size), strides=(1, stride_length), padding='same', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    ...
    model.add(Conv2D(conv2D_filter_amount, (3, conv2D_filter_size), strides=(1, stride_length), padding='same', activation='relu', input_shape=(5, 512, 1)))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    ...
    model.add(Conv2D(conv2D_filter_amount, (3, conv2D_filter_size), strides=(1, stride_length), padding='same', activation='relu', input_shape=(5, 512, 1)))
    model.add(Conv2D(conv2D_filter_amount, (3, conv2D_filter_size), strides=(1, stride_length), padding='same', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu'))

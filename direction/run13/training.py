...
model.add(Conv2D(conv2D_filter_amount, (1, 10), strides=(1, 2), padding='valid', activation='relu', input_shape=(5, 512, 1)))
model.add(Conv2D(conv2D_filter_amount, (1, 10), strides=(1, 2), padding='valid', activation='relu'))
model.add(Conv2D(conv2D_filter_amount, (1, 10), strides=(1, 2), padding='valid', activation='relu'))
model.add(Conv2D(conv2D_filter_amount, (1, 10), strides=(1, 2), padding='valid', activation='relu'))
model.add(Conv2D(conv2D_filter_amount, (1, 10), strides=(1, 2), padding='valid', activation='relu'))

...
if run_name == "run25.1":
    model.add(Dense(4 * 512, activation='relu'))
    model.add(Dense(4 * 512, activation='relu'))
    model.add(Dense(4 * 512, activation='relu'))
    ...
    model.add(Dense(128, activation='relu'))
    # model.add(Dropout(.1))
elif run_name == "run25.7":
    model.add(Dense(3 * 512, activation='relu'))
    model.add(Dense(3 * 512, activation='relu'))
    model.add(Dense(3 * 512, activation='relu'))
    model.add(Dense(1024, activation='relu'))
    # model.add(Dropout(.2))

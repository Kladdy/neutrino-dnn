...
if this_run_id == "1":
    ...
    optimizer = "RMSprop"
    run_optimizer = RMSprop(lr=learning_rate)
elif this_run_id == "4":
    optimizer = "Adadelta"
    run_optimizer = Adadelta(lr=learning_rate)
elif this_run_id == "5":
    optimizer = "Adagrad"
    run_optimizer = Adagrad(lr=learning_rate)
elif this_run_id == "6":
    optimizer = "Adamax"
    run_optimizer = Adamax(lr=learning_rate)
elif this_run_id == "7":
    optimizer = "Nadam"
    run_optimizer = Nadam(lr=learning_rate)
elif this_run_id == "8":
    optimizer = "Ftrl"
    run_optimizer = Ftrl(lr=learning_rate)
...
wandb.log({f"optimizer": optimizer})
...
#os.system(f"python plot_loss.py {run_id}") DONT DO THIS FOR RUN50! it breaks ;) 

...
if this_run_id in ["1", "2", "3"]:
 
    model.add(Conv2D(32, (1, 5), strides=(1, 1), padding='same', activation='relu', input_shape=(5, 512, 1)))
...
elif this_run_id in ["4", "5", "6"]:
    model.add(Conv2D(32, (1, 3), strides=(1, 1), padding='same', activation='relu', input_shape=(5, 512, 1)))
...
if this_run_id in ["1", "4"]:
    ...
    # model.add(Dropout(.1))
elif this_run_id in ["2", "5"]:
    model.add(Dense(256, activation='relu'))
    # model.add(Dropout(.1))
    model.add(Dense(128, activation='relu'))
    # model.add(Dropout(.1))
elif this_run_id in ["3", "6"]:
    model.add(Dense(128, activation='relu'))
    # model.add(Dropout(.1))

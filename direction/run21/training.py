...
model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu', input_shape=(5, 512, 1), data_format='channels_first'))
model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu', data_format='channels_first'))
model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu', data_format='channels_first'))
model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu', data_format='channels_first'))
model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, stride_length), padding='valid', activation='relu', data_format='channels_first'))

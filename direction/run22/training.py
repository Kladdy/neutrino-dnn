...
if run_name == "run22.1":
    ...
    model.add(Dense(128, activation='relu'))
    # model.add(Dropout(.1))
elif run_name == "run22.3":
    model.add(Dense(5 * 512, activation='relu'))
    # model.add(Dropout(.1))
    model.add(Dense(128, activation='relu'))
    # model.add(Dropout(.1))
elif run_name == "run22.4":
    model.add(Dense(5 * 512, activation='relu'))
    model.add(Dense(5 * 512, activation='relu'))
    # model.add(Dropout(.1))
    model.add(Dense(128, activation='relu'))
    # model.add(Dropout(.1))
elif run_name == "run22.5":
    model.add(Dense(5 * 512, activation='relu'))
    model.add(Dense(5 * 512, activation='relu'))
    # model.add(Dropout(.1))
    model.add(Dense(1024, activation='relu'))
    # model.add(Dropout(.1))
elif run_name == "run22.6":
    model.add(Dense(5 * 512, activation='relu'))
    # model.add(Dropout(.1))
    model.add(Dense(1024, activation='relu'))
    # model.add(Dropout(.1))
elif run_name == "run22.7":
    model.add(Dense(1024, activation='relu'))
    # model.add(Dropout(.1))
elif run_name == "run22.8":
    model.add(Dense(4096, activation='relu'))
    # model.add(Dropout(.1))
    model.add(Dense(1024, activation='relu'))
    # model.add(Dropout(.1))
elif run_name == "run22.9":
    model.add(Dense(4096, activation='relu'))
    # model.add(Dropout(.1))
elif run_name == "run22.10":

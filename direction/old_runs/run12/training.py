...
if run_name == "run12.1":
    filter_amount = 10
elif run_name == "run12.2":
    filter_amount = 50
elif run_name == "run12.3":
    filter_amount = 100
elif run_name == "run12.4":
    filter_amount = 150
elif run_name == "run12.5":
    filter_amount = 200

# Initial convolutional layers
model.add(Conv2D(filter_amount, (1, 10), strides=(1, 2), padding='valid', activation='relu', input_shape=(5, 512, 1)))
model.add(Conv2D(filter_amount, (1, 10), strides=(1, 2), padding='valid', activation='relu'))
model.add(Conv2D(filter_amount, (1, 10), strides=(1, 2), padding='valid', activation='relu'))
model.add(Conv2D(filter_amount, (1, 10), strides=(1, 2), padding='valid', activation='relu'))
model.add(Conv2D(filter_amount, (1, 10), strides=(1, 2), padding='valid', activation='relu'))

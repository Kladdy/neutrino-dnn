...
if run_name == "run27.1":
    ...
    model.add(Dense(128, activation='relu'))
    # model.add(Dropout(.1))
elif run_name == "run27.3":
    model.add(Dense(5 * 512, activation='relu'))
    model.add(Dense(5 * 512, activation='relu'))
    model.add(Dense(128, activation='relu'))
    # model.add(Dropout(.1))
elif run_name == "run27.4":
    model.add(Dense(5 * 512, activation='relu'))
    model.add(Dense(1024, activation='relu'))
    # model.add(Dropout(.2))
    model.add(Dense(256, activation='relu'))
    ...
    model.add(Dense(128, activation='relu'))
    # model.add(Dropout(.1))
elif run_name == "run27.5":
    model.add(Dense(5 * 512, activation='relu'))
    model.add(Dense(256, activation='relu'))
    # model.add(Dropout(.1))
    model.add(Dense(128, activation='relu'))
    # model.add(Dropout(.1))
elif run_name == "run27.6":
    model.add(Dense(5 * 512, activation='relu'))
    model.add(Dense(128, activation='relu'))
    # model.add(Dropout(.1))
elif run_name == "run27.7":
    model.add(Dense(1024, activation='relu'))
    # model.add(Dropout(.2))
    model.add(Dense(256, activation='relu'))
    # model.add(Dropout(.1))
    model.add(Dense(128, activation='relu'))
    # model.add(Dropout(.1))
elif run_name == "run27.8":
    model.add(Dense(256, activation='relu'))
    # model.add(Dropout(.1))
    model.add(Dense(128, activation='relu'))
    # model.add(Dropout(.1))
elif run_name == "run27.9":
    model.add(Dense(128, activation='relu'))
    # model.add(Dropout(.1))

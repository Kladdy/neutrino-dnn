...
elif this_run_id in ["2", "5", "8"]:
    conv2D_filter_amount = 64

elif this_run_id in ["3", "6", "9"]:
    conv2D_filter_amount = 128
...
wandb.log({"examples": [wandb.Image(ang_res_image, caption=f"Angular resolution for {run_name}")]})

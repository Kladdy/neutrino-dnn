...
if run_name == "run28.1":
    conv2D_filter_amount = 100
    conv2D_filter_size = 15
elif run_name == "run28.2":
    conv2D_filter_amount = 100
    conv2D_filter_size = 15
elif run_name == "run28.3":
    conv2D_filter_amount = 100
    conv2D_filter_size = 15
elif run_name == "run28.4":
    conv2D_filter_amount = 150
    conv2D_filter_size = 15
elif run_name == "run28.5":
    conv2D_filter_amount = 150
    conv2D_filter_size = 15
elif run_name == "run28.6":
    conv2D_filter_amount = 150
    conv2D_filter_size = 15
elif run_name == "run28.7":
    conv2D_filter_amount = 50
    conv2D_filter_size = 15
elif run_name == "run28.8":
    conv2D_filter_amount = 50
    conv2D_filter_size = 15
elif run_name == "run28.9":
    conv2D_filter_amount = 50
    conv2D_filter_size = 15
elif run_name == "run28.10":
    conv2D_filter_amount = 100
    conv2D_filter_size = 15

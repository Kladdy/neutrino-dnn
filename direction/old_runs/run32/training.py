...
if run_name == "run32.1":
    multiplication_to_prefetch = 2
elif run_name == "run32.2":
    multiplication_to_prefetch = 4
elif run_name == "run32.3":
    multiplication_to_prefetch = 8
elif run_name == "run32.4":
    multiplication_to_prefetch = 16
elif run_name == "run32.5":
    multiplication_to_prefetch = 32
elif run_name == "run32.6":
    multiplication_to_prefetch = 64
...
wandb.log({f"multiplication_to_prefetch": multiplication_to_prefetch})
...
dataset_train = tf.data.Dataset.range(n_files_train).prefetch(n_batches_per_file * multiplication_to_prefetch).interleave(
        TrainDataset,
        cycle_length=2,
...
dataset_val = tf.data.Dataset.range(n_files_val).prefetch(n_batches_per_file * multiplication_to_prefetch).interleave(
        ValDataset,
        cycle_length=2,
        num_parallel_calls=2,
        deterministic=False)

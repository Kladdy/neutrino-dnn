...
if run_name == "run19.1":
    ...
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, 2), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, 2), padding='valid', activation='relu'))
elif run_name == "run19.2":
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, 2), padding='valid', activation='relu', input_shape=(5, 512, 1)))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, 2), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, 2), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, 20), strides=(1, 2), padding='valid', activation='relu'))
elif run_name == "run19.3":
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, 2), padding='valid', activation='relu', input_shape=(5, 512, 1)))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, 2), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, 2), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, 25), strides=(1, 2), padding='valid', activation='relu'))    
elif run_name == "run19.4":
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, 2), padding='valid', activation='relu', input_shape=(5, 512, 1)))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, 2), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, 2), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, 30), strides=(1, 2), padding='valid', activation='relu'))
if run_name == "run19.5":
    model.add(Conv2D(conv2D_filter_amount, (1, 20), strides=(1, 2), padding='valid', activation='relu', input_shape=(5, 512, 1)))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, 2), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, 2), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, 2), padding='valid', activation='relu'))
elif run_name == "run19.6":
    model.add(Conv2D(conv2D_filter_amount, (1, 25), strides=(1, 2), padding='valid', activation='relu', input_shape=(5, 512, 1)))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, 2), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, 2), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, 2), padding='valid', activation='relu'))
elif run_name == "run19.7":
    model.add(Conv2D(conv2D_filter_amount, (1, 20), strides=(1, 2), padding='valid', activation='relu', input_shape=(5, 512, 1)))
    model.add(Conv2D(conv2D_filter_amount, (1, 20), strides=(1, 2), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, 2), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, 2), padding='valid', activation='relu'))    
elif run_name == "run19.8":
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, 2), padding='valid', activation='relu', input_shape=(5, 512, 1)))
    model.add(Conv2D(conv2D_filter_amount, (1, conv2D_filter_size), strides=(1, 2), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, 20), strides=(1, 2), padding='valid', activation='relu'))
    model.add(Conv2D(conv2D_filter_amount, (1, 20), strides=(1, 2), padding='valid', activation='relu'))
